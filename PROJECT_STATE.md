...
| Area | Status | Notes |
|---|---|---|
| Core policy engine | ✅ Working | policy.ts — blocklist + traversal |
...
| Directory operations | ✅ Working | mkdir/rmdir implemented |
...
**Completed:** README.md complete rewrite (Phase 5)

README.md now contains:
- Title + one-line description
- The Problem — specific real failure modes without PatchGate
- How It Works — text-based architecture diagram
- Installation
- CLI Usage with real examples
- Library Usage with TypeScript examples
- OpenAI Adapter section
- Claude Adapter section
- Config Reference table
- Feature Status table — only lists what actually works
- License

**Next Phase:** Directory operations (Phase 6) or Polish (Phase 7)
